...
static void ui_about(struct uih_context *uih)
{
    ...
    QMessageBox::about(
        ...
        "<a href=\"https://xaos-project.github.io/\">" +
            ...
            "Copyright © 1996-2025 <a href=\"https://github.com/xaos-project/XaoS/blob/master/CREDITS.md\">XaoS Contributors</a><br>"
            "<br>"
            "This program is free software; you can redistribute it and/or modify "
            "it under the terms of the GNU General Public License as published by "
            "the Free Software Foundation; either version 2 of the License, or "
...
const char *languages1[] = {
    "__", "hy", "zh", "cs", "en", "fr", "de", "he", "hi", "hu", "is", "it", "pt", "ro", "ru", "rs", "es", "sv", "tr", "vi"
};
const char *languages2[] = {
    "_____", "hy_HY", "zh_CN", "cs_CZ", "en_US", "fr_FR", "de_DE", "he_IL", "hi_HI", "hu_HU", "is_IS", "it_IT", "pt_PT", "ro_RO", "ru_RU", "rs_RS", "es_ES", "sv_SV", "tr_TR", "vi_VN"
};
...
static void ui_registermenus_i18n(void)
{
    ...
    MENUINTRB_I("setlang", NULL, "Chinese", "zh", UI, uih_setlanguage,
                UIH_LANG_ZH, ui_languageselected);
