...
#else
    printf ("Fatal error - constant O_NONBLOCK used for non-blocking IO in the pipe handling" "is unknown at the moment of compilation. The non-blocking IO will not work. " "Please ask authors...\n");
    exit (0);
#endif
}
