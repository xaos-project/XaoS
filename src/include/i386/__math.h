...
__inline_mathcode (__sgn, __x, return __x == 0.0 ? 0.0 : (__x > 0.0 ? 1.0 : -1.0)) __inline_mathcode (__pow2, __x, register long double __value;
                                                                                                      register long double __exponent;
                                                                                                      __extension__ long long int __p = (long long int)__x;
                                                                                                      if (__x == (long double) __p)
                                                                                                      {
__asm __volatile__ ("fscale": "=t" (__value):                                                        "0" (1.0), "u" (__x)); return __value;}
...
__MATH_INLINE void __sincosl (long double __x, long double *__sinx, long double *__cosx);
__MATH_INLINE void
...
#define __atan2_code \
  ...
  return __value
    __inline_mathcode2 (atan2, __y, __x, __atan2_code) __inline_mathcode2_ (long double, __atan2l, __y, __x, __atan2_code) __inline_mathcode2 (fmod, __x, __y, register long double __value;
__asm __volatile__ ("1:	fprem\n\t" "fnstsw	%%ax\n\t" "sahf\n\t" "jp	1b": "=t" (__value): "0" (__x), "u" (__y):                    "ax", "cc");
                                                                                                                                               return __value) __inline_mathcode2 (pow, __x, __y, register long double __value;
                                                                                                                                                                                   register long double __exponent;
                                                                                                                                                                                   __extension__ long long int __p = (long long int)__y;
                                                                                                                                                                                   if (__x == 0.0 && __y > 0.0) return 0.0; if (__y == (double) __p)
                                                                                                                                                                                   {
                                                                                                                                                                                   long double __r = 1.0; if (__p == 0) return 1.0; if (__p < 0) {
                                                                                                                                                                                   __p = -__p; __x = 1.0 / __x;}
                                                                                                                                                                                   while (1) {
                                                                                                                                                                                   if (__p & 1) __r *= __x; __p >>= 1; if (__p == 0) return __r; __x *= __x;}
                                                                                                                                                                                   /* NOTREACHED */
                                                                                                                                                                                   }
...
__asm __volatile__ ("fyl2x": "=t" (__value): "0" (__x), "u" (1.0): "st(1)"); __asm __volatile__ ("fmul	%%st(1)		# y * log2(x)\n\t" "fst	%%st(1)\n\t" "frndint			# int(y * log2(x))\n\t" "fxch\n\t" "fsub	%%st(1)		# fract(y * log2(x))\n\t" "f2xm1			# 2^(fract(y * log2(x))) - 1\n\t": "=t" (__value), "=u" (__exponent): "0" (__y), "1" (__value)); __value += 1.0; __asm __volatile__ ("fscale": "=t" (__value):"0" (__value), "u" (__exponent)); return __value)
    ...
    __inline_mathop (sqrt, "fsqrt") __inline_mathop_ (long double, __sqrtl, "fsqrt")
#if defined __GNUC__ && (__GNUC__ > 2 || __GNUC__ == 2 && __GNUC_MINOR__ >= 8)
    __inline_mathcode_ (double, fabs, __x, return __builtin_fabs (__x)) __inline_mathcode_ (float, fabsf, __x, return __builtin_fabsf (__x)) __inline_mathcode_ (long double, fabsl, __x, return __builtin_fabsl (__x)) __inline_mathcode_ (long double, __fabsl, __x, return __builtin_fabsl (__x))
#else
        __inline_mathop (fabs, "fabs") __inline_mathop_ (long double, __fabsl, "fabs")
#endif
/* The argument range of this inline version is reduced.  */
      __inline_mathop (sin, "fsin")
/* The argument range of this inline version is reduced.  */
      __inline_mathop (cos, "fcos") __inline_mathop (atan, "fld1; fpatan") __inline_mathop (log, "fldln2; fxch; fyl2x") __inline_mathop (log10, "fldlg2; fxch; fyl2x") __inline_mathcode (asin, __x, return __atan2l (__x, __sqrtl (1.0 - __x * __x))) __inline_mathcode (acos, __x, return __atan2l (__sqrtl (1.0 - __x * __x), __x)) __inline_mathcode_ (long double, __sgn1l, __x, return __x >= 0.0 ? 1.0 : -1.0)
/* The argument range of the inline version of sinhl is slightly reduced.  */
      __inline_mathcode (sinh, __x, register long double __exm1 = __expm1l (__fabsl (__x));
                         return 0.5 * (__exm1 / (__exm1 + 1.0) + __exm1) * __sgn1l (__x)) __inline_mathcode (cosh, __x, register long double __ex = __expl (__x);
                                                                                                             return 0.5 * (__ex + 1.0 / __ex)) __inline_mathcode (tanh, __x, register long double __exm1 = __expm1l (-__fabsl (__x + __x));
                                                                                                                                                                  return __exm1 / (__exm1 + 2.0) * __sgn1l (-__x)) __inline_mathcode (floor, __x, register long double __value;
...
__asm __volatile ("fldcw %0": :                                                                                                                                                                                                      "m" (__cw));
                                                                                                                                                                                                                                      return __value) __inline_mathcode (ceil, __x, register long double __value;
                                                                                                                                                                                                                                                                         __volatile unsigned short int __cw;
                                                                                                                                                                                                                                                                         __volatile unsigned short int __cwtmp;
__asm __volatile ("fnstcw %0":                                                                                                                                                                                                                                          "=m" (__cw));
...
#define __M_SQRT2	1.41421356237309504880L /* sqrt(2) */
    __inline_mathcode (log1p, __x, register long double __value;
                       if (__fabsl (__x) >= 1.0 - 0.5 * __M_SQRT2) __value = logl (1.0 + __x);
                       else
__asm __volatile__ ("fldln2\n\t" "fxch\n\t" "fyl2xp1": "=t" (__value):"0" (__x)); return __value)


/* The argument range of the inline version of asinhl is slightly reduced.  */
    __inline_mathcode (asinh, __x, register long double __y = __fabsl (__x);
                       return (log1pl (__y * __y / (__sqrtl (__y * __y + 1.0) + 1.0) + __y) * __sgn1l (__x))) __inline_mathcode (acosh, __x, return logl (__x + __sqrtl (__x - 1.0) * __sqrtl (__x + 1.0))) __inline_mathcode (atanh, __x, register long double __y = __fabsl (__x);
                                                                                                                                                                                                                               return -0.5 * log1pl (-(__y + __y) / (1.0 + __y)) * __sgn1l (__x))
/* The argument range of the inline version of hypotl is slightly reduced.  */
    __inline_mathcode2 (hypot, __x, __y, return __sqrtl (__x * __x + __y * __y)) __inline_mathcode (logb, __x, register long double __value;
...
__inline_mathcode3 (fma, __x, __y, __z, return (__x * __y) + __z) __inline_mathop (rint, "frndint")
#define __lrint_code \
  long int __lrintres;							      \
...
__inline_mathcode (__coshm1, __x, register long double __exm1 = __expm1l (__fabsl (__x));
                   return 0.5 * (__exm1 / (__exm1 + 1.0)) * __exm1) __inline_mathcode (__acosh1p, __x, return log1pl (__x + __sqrtl (__x) * __sqrtl (__x + 2.0)))
#endif /* __USE_MISC  */
...
/* This code is used internally in the GNU libc.  */
    ...
    __inline_mathop (__ieee754_sqrt, "fsqrt") __inline_mathcode2 (__ieee754_atan2, __y, __x, register long double __value;
