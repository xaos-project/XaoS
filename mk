...
8c -O -D_plan9_ -I src/include src/ui-hlp/*[~d].c
8c -O -D_plan9_ -I src/include src/util/[~tbx]*.c src/util/timers.c src/util/x[~l]*.c
8c -O  -D_plan9_ -O -I src/include src/filter/[a-f]*.c src/filter/[h-z]*.c src/filter/grlib.c
